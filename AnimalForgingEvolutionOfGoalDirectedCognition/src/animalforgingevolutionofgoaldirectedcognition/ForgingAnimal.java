...
public class ForgingAnimal{
    ...
    public ForgingAnimal( int id, int genotype, int lifespan ){
        this.id = id;
...
//        System.out.println( "Competitive Strength: " + competition_strength );
        ...
        //starting off the ForgingAnimal is assumed to have not yet eaten
